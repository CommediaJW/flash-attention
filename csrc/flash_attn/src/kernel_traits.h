...
struct Flash_kernel_traits {
    ...
    using SmemCopyAtomAccum = Copy_Atom<DefaultCopy, ElementAccum>;
#else
...
struct Flash_fwd_kernel_traits : public Base {
    ...
    using SmemCopyAtomAccum = typename Base::SmemCopyAtomAccum;
    ...
    static constexpr int kSmemBiasSize = size(SmemLayoutBias{}) * sizeof(ElementAccum);
